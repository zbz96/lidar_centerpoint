...
public:
  ...
  virtual std::size_t pointsToVoxels(const sensor_msgs::msg::PointCloud2 & input_pointcloud_msg,
...
public:
  ...
  std::size_t pointsToVoxels(const sensor_msgs::msg::PointCloud2 & input_pointcloud_msg,
    std::vector<float> & voxels, std::vector<int> & coordinates,

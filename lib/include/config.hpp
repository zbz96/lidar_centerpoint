...
public:
  ...
  constexpr static std::size_t point_feature_size = 4;  // x, y, z and intensity
  // constexpr static std::size_t box_feature_size = 9;    // x, y, z, l, w, h, rot, vel_x, vel_y
  constexpr static std::size_t box_feature_size = 7;    // x, y, z, l, w, h, rot
  ...
  */
  constexpr static float range_min_x = -60.0f;
  constexpr static float range_min_y = -19.2f;
  // constexpr static float range_min_z = -3.0f;
   constexpr static float range_min_z = -0.5f;
  constexpr static float range_max_x = 80.8f;
  constexpr static float range_max_y = 19.2f;
  // constexpr static float range_max_z = 2.0f;
  constexpr static float range_max_z = 4.5f;
  ...
  // constexpr static float voxel_size_z = 8.0f;
    constexpr static float voxel_size_z = 5.0f;

  // network params
  constexpr static std::size_t batch_size = 1;
  // constexpr static std::size_t downsample_factor = 2;
  constexpr static std::size_t downsample_factor = 1;
  // constexpr static std::size_t encoder_in_feature_size = 9;
  constexpr static std::size_t encoder_in_feature_size = 10;
  // constexpr static std::size_t encoder_out_feature_size = 32;
  constexpr static std::size_t encoder_out_feature_size = 64;
  // constexpr static std::size_t head_out_size = 6;
  constexpr static std::size_t head_out_size = 5;
